...
def test_format_declaration_contains_key_fields():
    env = {"worktree": "/wt", "branch": "br", "scan_ts": "20260727T185832",
           ...
           "params_summary": "burst(...)", "symbol": "DVLT", "instance_id": "tb_257_258",
...
def test_rebuild_params_roundtrip():
    ...
    # tb 字段随 ThrowbackDetectorV4 换代(2026-08-16):六字段见 params.TbParams
    ...
    snapshot = {
        ...
        "tb": {"max_rise_k": 1.5, "stop_confirm_bars": 1, "vol_window": 14,
    ...
    assert p.tb.max_rise_k == 1.5 and p.tb.anchor_mode == "span_min"
