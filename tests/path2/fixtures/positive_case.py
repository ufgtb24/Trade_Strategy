...
bottom_burst match. The only reliably-hitting combo is the synthetic
...
from path2_apps.bottom_burst.params import Params, BoParams, BurstParams


def positive_case():
    """Return (df, params) that reliably produces >=1 bottom_burst match."""
    params = Params(
