...
用于编辑 configs/analysis/config.yaml 的配置
"""
...
class ScanConfigDialog:
    ...
    def _load_current_config(self):
        ...
        if loader.is_using_user_config():
            self.status_label.config(
                text="Using: user_config.yaml", foreground="blue"
            )
        else:
            self.status_label.config(
                text="Using: config.yaml (default)", foreground="gray"
            )
    ...
    def _save_config(self):
        ...
        try:
            ...
            self.status_label.config(
                text="Saved to: user_config.yaml",
                foreground="green",
            )
