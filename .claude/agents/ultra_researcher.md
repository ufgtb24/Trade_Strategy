...
1.  **Research & Discovery**
    ...
    - Consult available documentation (`docs/system/`) and code context thoroughly.
...
- Do NOT create external documentation files unless explicitly requested.
...
- ✅ ALWAYS read `docs/system/current_state.md` and `docs/system/PRD.md` for context.
