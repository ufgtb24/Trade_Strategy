...
class DailyPipeline:
    ...
    def _step2_scan(self) -> list[dict]:
        ...
        # 实施时待验证: label_max_days=0 是否被 ScanManager 接受。
        # 若不接受改用 1 或修改 ScanManager 支持 0。
        mgr = ScanManager(
    ...
    def _step4_sentiment_analysis(
        ...
        def _analyze_with_retry(ticker: str, bo_date_str: str):
        ...
        for i, cand in enumerate(candidates):
            ...
            report = _analyze_with_retry(cand.symbol, cand.breakout_date)
