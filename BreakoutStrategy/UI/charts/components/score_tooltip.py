...
from ....analysis.breakout_scorer import BreakoutScorer, ScoreBreakdown, BonusDetail
...
class ScoreDetailWindow:
    ...
    def _build_breakout_card(self, parent: tk.Frame):
        """构建突破卡片"""
        breakdown = self.breakout_scorer.get_breakout_score_breakdown_bonus(self.breakout)
