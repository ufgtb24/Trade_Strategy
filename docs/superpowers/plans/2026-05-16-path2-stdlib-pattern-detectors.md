...
- [ ] **A-C2**(redesign §1 CRITICAL-2 / CHECK-3 锚):`edges=[A→C(1,3), B→C(0,0)]`,`A=[ev(0,1),ev(1,3),ev(4,5)]`,`B=[ev(0,1),ev(1,1),ev(5,6)]`,`C=[ev(3,3),ev(3,6),ev(6,7)]` → 产出 2 个,`children` 分别 `(A(1,3),B(5,6),C(6,7))`、`(A(4,5),B(5,6),C(6,7))`,按 end_idx 升序(两者 end=7,顺序任意)(旧码返回 `[]`)。
