...
class BaseParameterInput:
    ...
    def __init__(
        ...
        # param_value=None 表示 YAML 中缺失，fallback 到 schema default
        self.param_value = param_value if param_value is not None else param_config.get("default")
...
class IntInput(BaseParameterInput):
    ...
    def _create_widgets(self):
        ...
        # Column 1: Spinbox
        self.spinbox_var = tk.IntVar(value=self.param_value if self.param_value is not None else min_val)
...
class FloatInput(BaseParameterInput):
    ...
    def _create_widgets(self):
        ...
        # Column 1: Entry
        self.entry_var = tk.StringVar(value=str(self.param_value if self.param_value is not None else min_val))
...
class BoolInput(BaseParameterInput):
    ...
    def _create_widgets(self):
        ...
        self.bool_var = tk.BooleanVar(value=bool(self.param_value) if self.param_value is not None else False)
...
class ListInput(BaseParameterInput):
    ...
    def _create_widgets(self):
        ...
        # Column 1: Entry
        # 将列表转为逗号分隔字符串
        if self.param_value is not None and self.param_value:
