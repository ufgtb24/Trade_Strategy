...
PARAM_CONFIGS = {
    ...
    "quality_scorer": {
        ...
        "pbm_bonus": {
            ...
            "description": "PBM bonus (突破前涨势): thresholds are momentum values",
            "sub_params": {
                "enabled": {
                    "type": bool,
                    "default": True,
                ...
                "thresholds": {
                    ...
                    "element_type": float,
                    "default": [0.001, 0.003],
                    "description": "Threshold levels (0.001=涨势, 0.003=强劲涨势)",
                },
                "values": {
                    "type": list,
                    "element_type": float,
        ...
        "streak_bonus": {
            ...
            "sub_params": {
                ...
                "thresholds": {
                    ...
                    "element_type": int,
                    "default": [2],
                    "description": "Threshold levels (2+ breakouts)",
                },
                "values": {
                    "type": list,
                    "element_type": float,
        ...
        "intraday_return_vol_bonus": {
            ...
            "description": "Intraday Return Vol bonus (日内涨幅波动率标准化): thresholds in σ (intraday_return / daily_vol)",
            "sub_params": {
                "enabled": {
                    "type": bool,
                    "default": True,
                    "description": "Enable intraday return volatility bonus",
                },
                "thresholds": {
                    "type": list,
                    "element_type": float,
                    "default": [2.0, 3.0],
                    "description": "Threshold levels (2σ, 3σ)",
                },
                "values": {
                    "type": list,
                    "element_type": float,
        ...
        "gap_vol_bonus": {
            ...
            "description": "Gap Vol bonus (跳空波动率标准化): thresholds in σ (gap_up_pct / daily_vol)",
            "sub_params": {
                "enabled": {
                    "type": bool,
                    "default": True,
                    "description": "Enable gap volatility bonus",
                },
                "thresholds": {
                    "type": list,
                    "element_type": float,
                    "default": [1.0, 2.0],
                    "description": "Threshold levels (1σ, 2σ)",
                },
                "values": {
                    "type": list,
                    "element_type": float,
