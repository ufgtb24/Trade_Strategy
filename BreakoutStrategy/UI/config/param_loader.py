...
class UIParamLoader:
    ...
    def get_scorer_params(self) -> Dict[str, Any]:
        ...
        # Drought bonus（久旱逢甘霖）
        drought_bonus = quality_params.get('drought_bonus', {})
        ...
        # Breakout Day Strength bonus（突破日强度，max(IDR-Vol, Gap-Vol)）
        bds_bonus = quality_params.get('breakout_day_strength_bonus', {})
