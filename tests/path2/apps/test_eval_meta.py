"""eval_meta 协议:end_role 手声明 + head_buffer 从 Params 推导(参数改动自动传导)。"""
from dataclasses import replace

from path2_apps.bottom_breakout_burst import eval_meta
from path2_apps.bottom_breakout_burst.params import Params


def test_default_meta():
    """默认参数:end_role=tb,head_buffer=63(=bo_vol_baseline_period,当前最大 lookback)。"""
    assert eval_meta() == {"end_role": "tb", "head_buffer_trading_days": 63}
