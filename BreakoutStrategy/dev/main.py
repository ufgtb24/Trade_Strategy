...
class InteractiveUI:
    ...
    def _full_computation(
        ...
        breakouts, filtered_infos, detector = compute_breakouts_from_dataframe(
            ...
            breakout_mode=params.get("breakout_mode", "body_top"),
            ...
            pk_streak_window=params.get("pk_streak_window", 20),
    ...
    def _get_scan_params(self) -> tuple[dict, dict, dict]:
        ...
        feature_cfg = self.param_panel.param_loader.get_feature_calculator_params()
        scorer_cfg = self.param_panel.param_loader.get_scorer_params()
        return params, feature_cfg, scorer_cfg
    ...
    def _start_background_rescan(
        ...
        # 获取当前 UI 参数
        params, feature_cfg, scorer_cfg = self._get_scan_params()
